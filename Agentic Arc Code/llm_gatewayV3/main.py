...
load_dotenv(ROOT.parent / ".env")  # also check parent dir as fallback
...
DEFAULT_ORDER = ["llama31_8b", "gemma3_12b", "llama4_mav", "qwen3_80b", "claude_s4", "gpt_oss", "claude_s46"]
...
# Tier -> worker failover order. TINY prefers small fast models; LARGE prefers
# long-context models (claude/llama4_mav); HUGE is rejected.
TIER_TO_ORDER = {
    "TINY":  ["llama31_8b", "gemma3_12b", "qwen3_80b", "gpt_oss", "llama4_mav", "claude_s4", "claude_s46"],
    "LARGE": ["claude_s4", "claude_s46", "llama4_mav", "gpt_oss", "qwen3_80b", "gemma3_12b", "llama31_8b"],
}
            ...
            raise HTTPException(
                503,
                {
                    ...
                    "hint": "Use the Summarizer Agent (V7, not yet implemented). "
                            "For now, chunk the input or set provider=c explicitly to try Claude Sonnet 4 (200K ctx).",
