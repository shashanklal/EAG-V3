...
PRICING_USD_PER_MTOK: dict[str, tuple[float, float]] = {
    ...
    # Local — never charged.
    "ollama": (0.00, 0.00),
    # ── Databricks Mosaic AI Model Serving (pay-per-token list rates, rough) ──
    # Keyed by serving-endpoint name. Figures approximate published Databricks
    # pay-per-token / underlying vendor rates as of 2026-06; account contracts
    # may differ. Tokens remain the headline number — dollars are advisory.
    "databricks-claude-opus-4-8": (15.00, 75.00),
    "databricks-claude-opus-4-7": (15.00, 75.00),
    "databricks-claude-opus-4-6": (15.00, 75.00),
    "databricks-claude-opus-4-5": (15.00, 75.00),
    "databricks-claude-opus-4-1": (15.00, 75.00),
    ...
    "databricks-qwen35-122b-a10b": (0.50, 1.50),
    "databricks-gpt-oss-120b": (0.15, 0.75),
    "databricks-gpt-oss-20b": (0.05, 0.20),
    "databricks-llama-4-maverick": (0.50, 1.50),
    "databricks-gemma-3-12b": (0.05, 0.20),
    "databricks-meta-llama-3-1-8b-instruct": (0.05, 0.10),
}
